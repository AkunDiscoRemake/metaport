...
class Mesh private constructor(
    ...
    companion object {
        fun upload(vb: MeshBuilder, mode: Int = GLES30.GL_TRIANGLES): Mesh {
            ...
            GLES30.glVertexAttribPointer(0, 3, GLES30.GL_FLOAT, false, s, VertexLayout.POS_OFF * 4)
            GLES30.glEnableVertexAttribArray(1)
            GLES30.glVertexAttribPointer(1, 3, GLES30.GL_FLOAT, false, s, VertexLayout.NORMAL_OFF * 4)
            GLES30.glEnableVertexAttribArray(2)
            GLES30.glVertexAttribPointer(2, 2, GLES30.GL_FLOAT, false, s, VertexLayout.UV_OFF * 4)
            GLES30.glEnableVertexAttribArray(3)
            GLES30.glVertexAttribPointer(3, 4, GLES30.GL_FLOAT, false, s, VertexLayout.COLOR_OFF * 4)
